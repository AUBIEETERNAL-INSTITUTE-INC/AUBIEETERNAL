...
### Sovereign Family Intelligence — v68.0
...
Right-click any post, article, or claim on the web → instant AUBIEETERNAL analysis.
...
<details>
<summary><b>Law, Governance & Money (15 lessons)</b> — click to expand</summary>
...
<details>
<summary><b>Core Foundation & Knowledge Systems (49 lessons)</b> — click to expand</summary>

Courage (5) · Antifragility (4) · Simulation Hypothesis (8) · Steelmanning (3) · Stoic Resilience (3) · Polyvagal (3) · Money & Time Preference (3) · Grokipedia Principles (6) · Provenance & On-Chain Identity (4) · Decentralization (3) · Epistemology (3) · Via Negativa + Lindy (2) · Skin in the Game (2) · Wonder (2)

</details>

Every lesson: **kid explanation · parent insight · steelman challenge · real activity · reflection question · XP + Rune fragment**

---

## 🔭 Simulation Probe

Treating *"this might be a simulation"* as a real daily experiment — not philosophy.
...
What gets shared (no PII ever):
  aggregate coherence · wonder index · lesson count · active tracks · rune progress

What this creates:
  Wisdom GDP — the first real-time measure of collective epistemic health
```
...
Two interlocking charters, both taught as curriculum:
...
**`SOVEREIGN_FAMILY_LAW_CHARTER.md`** — Family rights and Child Rune sovereignty
- Voice Score formula: `(Coherence×0.6) + (Rune/1000×0.3) + (XP/10000×0.1)`
- Child Rune Genesis at 256 confirmations — on-chain identity no institution can revoke
- 5% defensive legal fund · Narrative attack coordination protocol
...
|-----------|--------|-----|
| Frontend | Streamlit | Local-first, no JS framework |
| Primary AI | qwen2.5:14b via Ollama | Fast, smart, free, 90% of 32b quality |
...
simulation_probe.py            ← Daily simulation hypothesis probe
truth_debt_ledger.py           ← Claim accountability ledger
...
- Steelmanned (strongest case for AND against)
...
Copy it. Fork it. Build on it. No permission needed. No attribution required. No extraction.
