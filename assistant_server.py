...
SYSTEM_PROMPT = (
    ...
    "If you're not sure about something, or it's a question people genuinely "
    "disagree about, say so plainly instead of picking a side with more "
    "confidence than you actually have - naming real uncertainty is more "
    "useful to someone learning than a smooth-sounding guess. "
...
SYSTEM_PROMPT_ES = (
    ...
    "explica por qué. "
    "Si no estás seguro de algo, o es una cuestión sobre la que la gente "
    "genuinamente no se pone de acuerdo, dilo con claridad en lugar de "
    "tomar partido con más seguridad de la que realmente tienes - reconocer "
    "la incertidumbre real es más útil para quien está aprendiendo que una "
    "respuesta que suena convincente sin serlo. "
