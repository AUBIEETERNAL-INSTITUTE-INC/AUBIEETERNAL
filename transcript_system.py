...
# ── Degree definitions (canonical) ──────────────────────────────────────────
from degrees import DEGREES, credits_from_xp
...
class TranscriptGenerator:
    ...
    def generate(self) -> Dict:
        ...
        for key in completed_keys:
            ...
            xp  = lesson.get("xp", 10)
            crd = xp  # accumulate raw xp; credits computed once below
            total_xp      += xp
            total_credits += crd  # raw xp here
        ...
        degrees_earned = []
        for deg in DEGREES:
            if (credits_from_xp(total_credits) >= deg["credits"] and
        ...
        transcript = {
            ...
            "academic_record": {
                "total_credits":    credits_from_xp(total_credits),
                "total_xp":         total_xp,
